...
RSpec.describe SyncService do
  ...
  describe '#sync_emails' do
    context 'with specific email account' do
      ...
      it 'raises SyncError for non-existent account' do
        ...
        }.to raise_error(SyncService::SyncError, "Cuenta de correo no encontrada.")
      end
      ...
      it 'raises SyncError for inactive account' do
        ...
        }.to raise_error(SyncService::SyncError, "La cuenta de correo está inactiva.")
      end
    end
  ...
  describe 'SyncError' do
    it 'is a StandardError subclass' do
      expect(SyncService::SyncError.new).to be_a(StandardError)
    end

    it 'accepts custom messages' do
      error = SyncService::SyncError.new("Custom error message")
