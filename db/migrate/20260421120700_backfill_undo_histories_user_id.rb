...
class BackfillUndoHistoriesUserId < ActiveRecord::Migration[8.1]
  ...
  def up
    ...
    # UndoHistory has no email_account_id — assign all NULL rows to admin user.
  ...
  def down
    raise ActiveRecord::IrreversibleMigration,
      "BackfillUndoHistoriesUserId is a one-way data migration. " \
