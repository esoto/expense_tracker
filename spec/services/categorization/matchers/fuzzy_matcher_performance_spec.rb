  ...
  describe "matching performance" do
    context "with realistic merchant data" do
      ...
      it "matches within 10ms for single query" do
        ...
        expect(max_time).to be < 15, "Max time: #{max_time.round(2)}ms"
      end
      
      it "handles typos within 10ms" do
        typo_queries = [
    ...
    context "with patterns" do
      ...
      it "matches patterns within 10ms" do
        ...
        expect(time * 1000).to be < 10, "Pattern matching took #{(time * 1000).round(2)}ms"
      end
    end
    ...
    context "with Spanish text" do
      ...
      it "normalizes Spanish text within 10ms" do
        ...
        queries.each do |query|
          ...
          expect(time * 1000).to be < 10, "Spanish query '#{query}' took #{(time * 1000).round(2)}ms"
        end
      end
    end
    ...
    describe "performance metrics" do
      it "tracks performance accurately" do
        ...
        5.times { |i| matcher.match_pattern("Pattern #{i}", []) }
        3.times { |i| matcher.match_merchant("Merchant #{i}", []) }
