...
RSpec.describe Categorization::EnhancedCategorizationService do
  ...
  describe "#categorize" do
    ...
    context "with multiple pattern types" do
      ...
      it "considers all pattern types" do
        expense.transaction_date = Time.current.change(hour: 8) # morning
  ...
  describe "#learn_from_feedback" do
    ...
    before do
      ...
      allow(service).to receive(:instance_variable_get)
        .with(:@last_matched_pattern).and_return(pattern)
    end
    ...
    it "records learning event" do
      ...
      expect(event.suggested_category).to eq(category)
  ...
  describe "performance" do
    ...
    it "batch categorizes efficiently" do
      ...
      expect(time_per_expense).to be < 10
    end
  end
end