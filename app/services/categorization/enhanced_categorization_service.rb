...
module Categorization
  ...
  class EnhancedCategorizationService
    ...
    def learn_from_feedback(expense, category, was_correct)
      ...
      if was_correct && expense.merchant_name.present?
        create_user_preference(expense.merchant_name, category)
      end
    ...
    def create_user_preference(merchant_name, category)
      UserCategoryPreference.find_or_create_by(
        context_type: "merchant",
        context_value: merchant_name.downcase.strip
      ) do |pref|
